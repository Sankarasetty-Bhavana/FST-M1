...
public class Activity5_Proj {
    ...
    public void testSearchAppium() {
        ...
        /// Scroll To do list
        driver.findElement(MobileBy.AndroidUIAutomator(UiScrollable + ".scrollForward(0).scrollIntoView(text(\"Login Form\"))")).click();
        ...
        MobileElement successLogin =  driver.findElementByXPath("//android.widget.TextView[@text='Welcome Back, admin']");
